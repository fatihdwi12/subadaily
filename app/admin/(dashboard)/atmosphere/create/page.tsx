...
export default function CreateAtmosphere() {
  ...
  // Upload file ke /api/upload lalu simpan path ke form.image
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="border border-white/15 rounded-2xl p-6 sm:p-8 w-full max-w-2xl">
        <h1 className="text-2xl font-bold mb-1">Add Atmosphere</h1>
        <p className="text-white/40 text-sm mb-8">
          Tambah konten atmosphere baru
        </p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          {/* Upload Gambar */}
          <Field label="Foto">
            <label className="flex flex-col items-center justify-center border border-dashed border-white/20 rounded-xl p-6 cursor-pointer hover:border-white/40 transition group">
              {preview ? (
