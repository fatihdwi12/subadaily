...
export default async function AdminDashboard() {
  const [atmosphereCount, teamCount, messageCount] = await Promise.all([
    ...
    prisma.team.count(),          // ← bukan teamMember
    prisma.message.count(),       // ← sesuaikan dengan nama model Message Anda
  ]);
  ...
  return (
    <div>
      <h1 className="text-2xl mt-10 sm:text-3xl font-bold mb-1">Dashboard</h1>
